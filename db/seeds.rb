...
Areana.create(name: "Darrel K Royal", capacity: 102000, state: "Texas", city: "College Austin", conference: "Big 12")
...
Areana.create(name: "Bryant-Denny", capacity: 101000, state: "Alabama", city: "Tuscaloosa", conference: "SEC")
Areana.create(name: "Neyland", capacity: 102000, state: "Tennessee", city: "Knoxville", conference: "SEC")
